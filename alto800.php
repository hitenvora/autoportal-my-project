...
<div class="row">
    <img src="https://apollo-singapore.akamaized.net/v1/files/b7ijaaw56g0d2-IN/image;s=780x0;q=60">
<br><br><br>
    <h1>Maruti Suzuki Alto (2011)</h1>
    <h6>LXI(O) </h6>
<h6>
        CNG&HYBRID
        ...
        MANUAL</h6>
<hr>
<i class="bi bi-person">2st</i><br>
<i class="bi bi-geo-alt-fill">Botad</i>
</div>
<hr>
...
<p>
    ...
    SELL FORE BRAND NEW ALTO LXI VERY GOOD CONDITION CAR NON ACCIDENTAL & NON REPAINTED CAR & COMPANY C.N.G. FITED THIS CAR..CALL & MSG ME MORE INFORMAYION
    ADDITIONAL VEHICLE INFORMATION: <br>
    Accidental: No <br>
    Adjustable External Mirror: Manual <br>
    Air Conditioning: With Heater <br>
    Aux Compatibility: Yes <br>
    Battery Condition: New <br>
    Bluetooth: Yes <br>
    Vehicle Certified: Yes <br>
    Color: Silver <br>
    Insurance Type: No Insurance <br>
    Lock System: Central <br>
    Make Month: November <br>
    AM/FM Radio: Yes <br>
    Registration Place: GJ <br>
    Exchange: Yes <br>
    Service History: Available <br>
    Tyre Condition: New <br>
    USB Compatibility: Yes <br>
</p>
<hr><br><br>
<button type="submit" class="btn btn-outline-success mb-5">Contect >></button>
