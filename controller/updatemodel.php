      ...
      <div class="card">
        <div class="card-body">
          ...
          <form method="post" id="frm1" enctype="multipart/form-data">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control" value=<?php echo $modelupdate[0]["model_name"];?> name="updmodels" id="inputText" data-bvalidator="required,alpha">
              </div>
            </div>
            ...
            <div class="text-center">
              <button type="submit" name="modelupd" class="btn btn-primary">SUBMIT</button>
