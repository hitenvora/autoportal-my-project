<?php 
$mainurl="http://localhost/topsAssignment/project/autoportal/admin/";
$baseurl="http://localhost/topsAssignment/project/autoportal/admin/assets/";
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <ul class="d-flex align-items-center">
      ...
      <li class="nav-item dropdown pe-3">
        ...
        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
          ...
          <li>
            <a class="dropdown-item d-flex align-items-center"   href="<?php echo $mainurl;?>?logout">
